...
public class InputKeyboard {
    ...
    //String fontFileName = "crystal.ttf";
    String keysFileName = "keys.png";

    private String text = ""; // вводимый текст
    // текст на кнопках
    private static final String LETTERS_EN_CAPS = "1234567890-~QWERTYUIOP+?^ASDFGHJKL;'`ZXCVBNM<> |"; // английский c capslock
    private static final String LETTERS_EN_LOW  = "1234567890_~qwertyuiop[]^asdfghjkl:'`zxcvbnm,. |"; // английский без capslock
    //private static final String LETTERS_EN_LOW  = "!@#$%:&*()_~qwertyuiop[]^asdfghjkl:'`zxcvbnm,. |"; // английский без capslock
    private static final String LETTERS_RU_CAPS = "1234567890-~ЙЦУКЕНГШЩЗХЪ^ФЫВАПРОЛДЖЭ`ЯЧСМИТЬБЮЁ|"; // русский с capslock
    private static final String LETTERS_RU_LOW  = "1234567890_~йцукенгшщзхъ^фывапролджэ`ячсмитьбюё|"; // русский без capslock
    //private static final String LETTERS_RU_LOW  = "!@#$%:&*()_~йцукенгшщзхъ^фывапролджэ`ячсмитьбюё|"; // русский без capslock
    ...
    public InputKeyboard(BitmapFont font, float scrWidth, float scrHeight, int textLength){
        this.font = font;
        //generateFont();
        ...
        keyHeight = height/5;
        padding = 4; // отступы между кнопками
        createKBD();
    }
